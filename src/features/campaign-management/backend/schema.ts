...
export const AdvertiserCampaignQuerySchema = z.object({
  sort: z
    ...
    .optional()
    .transform((value) =>
      value && ADVERTISER_CAMPAIGN_SORT_OPTIONS.includes(
  ...
  status: z
    ...
    .optional()
    .transform((value) =>
      value && CAMPAIGN_STATUS_OPTIONS.includes(value as (typeof CAMPAIGN_STATUS_OPTIONS)[number])
...
export const CampaignCreateRequestSchema = z
  ...
  .refine(
    (data) => data.recruitmentEndAt >= data.recruitmentStartAt,
    {
